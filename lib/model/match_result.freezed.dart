...
mixin _$MatchResult {
  ...
  int? get awayScore => throw _privateConstructorUsedError; // nullを許容
  String get homeTeamLogo => throw _privateConstructorUsedError;
  String get awayTeamLogo => throw _privateConstructorUsedError;
  int? get duration => throw _privateConstructorUsedError; // nullを許容
...
abstract class _MatchResult implements MatchResult {
  factory _MatchResult(
      ...
      final int? duration,
      required final String kickoffTime}) = _$MatchResultImpl;
